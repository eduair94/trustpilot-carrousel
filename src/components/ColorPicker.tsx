    ...
    <div className='relative'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <button
          ...
          style={{
            backgroundColor:
              localValue === 'transparent' ? 'transparent' : localValue,
            backgroundImage:
                    ...
                    style={{
                      ...
                      backgroundImage:
                        preset === 'transparent'
                          ...
                          : 'none',
                      backgroundSize:
                        preset === 'transparent' ? '4px 4px' : 'auto',
                      backgroundPosition:
                        preset === 'transparent'
        ...
        {themes.map(theme => (
          ...
          >
            <input
              ...
              onChange={e =>
                onChange(e.target.value as 'light' | 'dark' | 'custom')
              }
              className='sr-only'
            />
                  ...
                  style={{
                    ...
                    backgroundImage:
                      theme.preview.bg === 'transparent'
                        ...
                        : 'none',
                    backgroundSize:
                      theme.preview.bg === 'transparent' ? '4px 4px' : 'auto',
                    backgroundPosition:
                      theme.preview.bg === 'transparent'
                        ? '0 0, 0 2px, 2px -2px, -2px 0px'
                        : 'auto',
